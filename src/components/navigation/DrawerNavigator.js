...
/* eslint-disable */
const navigationOptions = (titleKaz, titleRus, withMenuButton = false) => ({
  navigation
}) => {
  const imgSource = withMenuButton ? images.menu : images.back;
  const onPress = () =>
    withMenuButton ? navigation.openDrawer() : navigation.goBack();
...
const stack = {
  ...
  FAQ: {
    screen: FAQ,
    navigationOptions: navigationOptions(
      settings.kaz.navigation.faq,
      settings.rus.navigation.faq
    )
  },
  ChatRooms: {
    screen: ChatRooms
  ...
  CalcScreen: {
    screen: CalcScreen,
    navigationOptions: navigationOptions(
      settings.kaz.navigation.calc,
      settings.rus.navigation.calc
    )
  },
  AlertScreen: {
    screen: AlertScreen
