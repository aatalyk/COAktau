...
import { View, ScrollView, Image, RefreshControl, StyleSheet } from 'react-native';
...
class AboutServiceScreen extends Component {
	...
	render() {
		...
		return (
			...
			>
				<HTMLView value={post[lang]} renderNode={this.renderNode} style={styles.htmlView} stylesheet={styles} />
			</ScrollView>
		);
	}
}
